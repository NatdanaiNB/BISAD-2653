      ...
      <div class="editform"> 
        <form action="Profile_update.php" method="post" class="form-group row">
          <label for="" class="col-2 col-form-label">
            <p name="lablename">Username:</p>
            
          </label>
          
          <div class="col-10">
          <input type="text" class="form-control"  placeholder="Username" name="name" id="name" value='<?=$name?>' required>
          </div>
          <label for="" class="col-2 col-form-label"
            ><p name="lablename">Email:</p></label
          >
          <div class="col-10">
            <input type="text" class="form-control" placeholder="email"name="picture" id="picture" value='<?=$picture?>' required />
          </div>
          <label for="" class="col-2 col-form-label"
